        ...
        NavigationView {
            ...
            .navigationBarItems(
                ...
                trailing: Button("保存") {
                    ...
                    newAlarm.setValue(UUID(), forKey: "id")
                    newAlarm.setValue(selectedTime, forKey: "time")
                    newAlarm.setValue(alarmLabel.isEmpty ? "闹钟" : alarmLabel, forKey: "label")
                    newAlarm.setValue(Array(selectedWeekdays), forKey: "weekdays")
                    newAlarm.setValue(true, forKey: "isEnabled")
